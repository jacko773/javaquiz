...
<form action="SignUp.jsp" method="GET" style="width:300px">  
  <div class="form-group">    
    <input type="text" class="form-control glyphicon" id="user" name="user" placeholder="&#57352 User name"/>
  </div> 		 
  <div class="form-group">    
    <input type="email" class="form-control glyphicon" id="InputEmail2" name="InputEmail2" placeholder="&#x2709 Email">  
  </div>  
  <div class="form-group">    
    <input type="password" class="form-control glyphicon" id="InputPassword2" name="InputPassword2" placeholder="&#57395 Password">  
  </div>
  <div class="form-group">   
